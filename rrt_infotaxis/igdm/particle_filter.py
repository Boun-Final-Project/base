...
class ParticleFilter:
    ...
    def update(self, measurement, sensor_position, time_step=None, skip_mcmc=False):
        ...
        skip_mcmc : bool, optional
            If True, skip MCMC move step (useful for RRT planning to save computation)
        """
    ...
    def _compute_likelihoods(self, measurement, sensor_position):
        """Compute likelihood for each particle given binary measurement.
    ...
    def predict_measurement_probability(self, sensor_position, binary_value=None, time_step=None):
        """Predict probability of binary measurement at a position.
        ...
        binary_value : {None, 0, 1}, optional
            If None, return tuple (P(0), P(1))
            If 0 or 1, return probability of that value
