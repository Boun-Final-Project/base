...
class RRTInfotaxisIGDMDiscreteLargeMap:
    ...
    def run(self):
        ...
        self.log("=" * 70)
        self.log("RRT-INFOTAXIS WITH IGDM + DISCRETE SENSOR + EXPLORATION PENALTY (Large Map)")
        self.log("=" * 70)
    ...
    def visualize_final(self, filename='rrt_infotaxis_igdm_improved_large_map_discrete_result.png'):
        ...
        ax1.set_title('RRT-Infotaxis Trajectory (IGDM + Discrete Sensor + Exploration Penalty, Large Map)', fontsize=12, fontweight='bold')
        ax1.set_xlabel('X (m)')
        ax1.set_ylabel('Y (m)')
...
if __name__ == "__main__":
    ...
    infotaxis = RRTInfotaxisIGDMDiscreteLargeMap(sigma_m=1.0, logger=logger)
    infotaxis.run()
    final_png = log_dir / "rrt_infotaxis_igdm_improved_large_map_discrete_result.png"
