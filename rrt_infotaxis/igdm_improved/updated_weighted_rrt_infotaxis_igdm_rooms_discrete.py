...
class RRTInfotaxisIGDMRoomsDiscreteWeighted:
    ...
    def __init__(self, sigma_m=1.0, logger=None):
        ...
        viz_dir = Path("/home/hdd/akademia/cmpe/final-project/week-10/updated_rrt_igdm_improved_rooms_discrete_weighted_steps")
