...
class RRTInfotaxisIGDM:
    ...
    def __init__(self, sigma_m=1.0,robot_start=None):
        ...
        # UPDATED: Source inside Room 1 (Top-Left), Robot in Central Hallway
        ...
        # --- UPDATED: 3-ROOM LAYOUT ---
        # Vertical walls
        # Room 1 (top-left) right wall
    ...
    def run(self):
        ...
        print("=" * 70)
        print("RRT-INFOTAXIS (MULTI-ROOM) + DISCRETE SENSOR + 4-WAY PRUNING + GEOMETRIC PENALTY")
        print("=" * 70)
        print(f"Environment: {self.room_width}m × {self.room_height}m (3 Rooms)")
        print(f"Room 1 (Top-Left), Room 2 (Bottom-Left), Room 3 (Top-Right)")
    ...
    def visualize_final(self, filename='rrt_infotaxis_igdm_discrete_multiroom_result.png'):
        ...
        ax1.set_title('RRT-Infotaxis Trajectory (Multi-Room)', fontsize=12, fontweight='bold')
        ax1.set_xlabel('X (m)')
        ax1.set_ylabel('Y (m)')
        
        # Plot room walls (Multi-Room)
