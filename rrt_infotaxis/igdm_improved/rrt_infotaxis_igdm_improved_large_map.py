"""
Standalone RRT-Infotaxis with IGDM (Indoor Gaussian Dispersion Model) on Large Map with Exploration Penalty.
...
class RRTInfotaxisIGDM:
    ...
    def take_step(self, step_num):
        ...
        if debug_info['best_penalty_applied']:
            ...
            penalized = debug_info['best_information_gain']
    ...
    def run(self):
        ...
        self.log("=" * 70)
        self.log("RRT-INFOTAXIS WITH IGDM + EXPLORATION PENALTY (Large Map with Room)")
        self.log("=" * 70)
    ...
    def visualize_final(self, filename='rrt_infotaxis_igdm_improved_large_map_result.png'):
        ...
        ax1.set_title('RRT-Infotaxis Trajectory (IGDM + Exploration Penalty, Large Map)', fontsize=12, fontweight='bold')
        ax1.set_xlabel('X (m)')
        ax1.set_ylabel('Y (m)')
...
if __name__ == "__main__":
    ...
    infotaxis = RRTInfotaxisIGDM(sigma_m=1.0, logger=logger)
    infotaxis.run()
    final_png = log_dir / "rrt_infotaxis_igdm_improved_large_map_result.png"
