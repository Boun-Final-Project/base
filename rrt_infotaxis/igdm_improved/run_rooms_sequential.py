"""
Sequential Execution Script for Rooms Implementations.

Runs all three rooms versions sequentially:
...
def run_binary_rrt():
    ...
    print("\n" + "="*70)
    print("EXECUTING: RRT-Infotaxis with Binary Sensor (Rooms)")
    print("="*70)

    start_time = time.time()
    process = subprocess.run(
        ['python', 'rrt_infotaxis_igdm_improved_rooms.py'],
...
def run_discrete_planner():
    ...
    print("\n" + "="*70)
    print("EXECUTING: RRT-Infotaxis with Discrete Sensor (Rooms)")
    print("="*70)
...
def run_directional_planner():
    ...
    print("\n" + "="*70)
    print("EXECUTING: Directional Planner with Discrete Sensor (Rooms)")
    print("="*70)
...
def main():
    ...
    print("\n" + "="*80)
    print("SEQUENTIAL EXECUTION: All Rooms Implementations")
    print("="*80)
