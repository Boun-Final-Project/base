...
ALGORITHM: RRT with 4-Way Initial Pruning + Geometric Penalty + Obstacle Adaptive.

Algorithm:
1. MEASURE: Take sensor measurement, update threshold
2. SENSE OBSTACLES: Check if robot is within 1.5m of a wall.
3. ADAPT:
...
class RRTInfotaxisIGDM:
    ...
    def __init__(self, sigma_m=1.0):
        ...
        self.max_steps = 200 # Increased for larger, complex map
        ...
        # --- UPDATED: Three Rectangular Obstacles ---
        ...
        # Use faster dispersion rate (3.0) for large map
        ...
        self.rrt = RRTInfotaxis4Way(self.grid, N_tn=self.std_N_tn, R_range=8, delta=1.0, max_depth=self.std_depth,
                      discount_factor=0.8, positive_weight=0.6)
        ...
        self.visualizer = StepVisualizer(output_dir="igdm_discrete_three_obstacle_adaptive_steps_weight_0.6", igdm_model=self.igdm)
    ...
    def is_near_obstacle(self, position, radius=0.75):
        ...
        Includes robust integer casting for array slicing.
        """
    ...
    def run(self):
        ...
        print("=" * 70)
        print("RRT-INFOTAXIS (3 OBSTACLES) + OBSTACLE-ADAPTIVE PLANNING")
        print("=" * 70)
        ...
        print(f"Adaptive: Near Wall (<{self.obstacle_proximity_thr}m) -> Boost N_tn/Depth")
        print("=" * 70)
    ...
    def visualize_final(self, filename='rrt_infotaxis_igdm_discrete_three_obstacles_result.png'):
        ...
        ax1.set_title('RRT-Infotaxis Trajectory (Three Obstacles + Adaptive)', fontsize=12, fontweight='bold')
        ax1.set_xlabel('X (m)')
        ax1.set_ylabel('Y (m)')
