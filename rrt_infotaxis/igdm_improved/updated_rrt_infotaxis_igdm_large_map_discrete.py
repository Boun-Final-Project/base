"""
Standalone RRT-Infotaxis with IGDM (Indoor Gaussian Dispersion Model) on Large Map with Discrete Sensor - UPDATED VERSION.
...
class RRTInfotaxisIGDMDiscreteLargeMapUpdated:
    """Standalone RRT-Infotaxis with IGDM and discrete sensor on large map (Updated version)."""
    ...
    def visualize_final(self, filename='updated_rrt_infotaxis_igdm_large_map_discrete_result.png'):
        ...
        if self.estimates:
            ...
            info_text = "RRT-INFOTAXIS RESULTS (LARGE MAP + DISCRETE SENSOR) - UPDATED\n"
            info_text += "="*40 + "\n\n"
