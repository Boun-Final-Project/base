...
class RRTInfotaxisIGDMRoomsDiscreteExtendedPenalty:
    ...
    def __init__(self, sigma_m=1.0, logger=None):
        ...
        viz_dir = Path("/home/hdd/akademia/cmpe/final-project/week-11/igdm_improved_rooms_discrete_extended_penalty_steps")
    ...
    def run(self):
        ...
        self.log("(Multi-Room Building - 20-step penalty window with 1.1x decay)")
        self.log("=" * 70)
    ...
    def visualize_final(self, filename='rrt_infotaxis_igdm_improved_rooms_discrete_extended_penalty_result.png'):
...
if __name__ == "__main__":
    ...
    log_file = log_dir / "rrt_infotaxis_igdm_improved_rooms_discrete_extended_penalty.log"
