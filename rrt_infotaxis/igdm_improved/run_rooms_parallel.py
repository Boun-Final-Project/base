"""
Parallel Execution Script for Rooms Implementations.

Runs five rooms versions in parallel:
...
def run_discrete_planner():
    ...
    print("\n" + "="*70)
    print("STARTING: Discrete RRT Planner (Rooms)")
    print("="*70)

    start_time = time.time()
    process = subprocess.run(
        ['python', 'rrt_infotaxis_igdm_improved_rooms_discrete.py'],
...
def run_directional_planner():
    ...
    print("\n" + "="*70)
    print("STARTING: Directional Planner (Rooms)")
    print("="*70)

    start_time = time.time()
    process = subprocess.run(
        ['python', 'rrt_infotaxis_igdm_improved_rooms_directional.py'],
        cwd=Path(__file__).parent,
        capture_output=False
    )
    elapsed_time = time.time() - start_time
...
def run_updated_rrt_planner():
    ...
    print("\n" + "="*70)
    print("STARTING: Updated RRT Planner (Rooms)")
    print("="*70)

    start_time = time.time()
    process = subprocess.run(
        ['python', 'updated_rrt_infotaxis_igdm_rooms_discrete.py'],
        cwd=Path(__file__).parent,
        capture_output=False
    )
    elapsed_time = time.time() - start_time
...
def run_updated_weighted_rrt_planner():
    ...
    print("\n" + "="*70)
    print("STARTING: Updated Weighted RRT Planner (Rooms)")
    print("="*70)

    start_time = time.time()
    process = subprocess.run(
        ['python', 'updated_weighted_rrt_infotaxis_igdm_rooms_discrete.py'],
        cwd=Path(__file__).parent,
        capture_output=False
    )
    elapsed_time = time.time() - start_time
...
def run_extended_penalty_planner():
    ...
    print("\n" + "="*70)
    print("STARTING: Extended Penalty Planner (Rooms)")
    print("="*70)

    start_time = time.time()
    process = subprocess.run(
        ['python', 'rrt_infotaxis_igdm_improved_rooms_discrete_extended_penalty.py'],
        cwd=Path(__file__).parent,
        capture_output=False
    )
    elapsed_time = time.time() - start_time
...
def main():
    ...
    print("\n" + "="*80)
    print("PARALLEL EXECUTION: All Rooms Implementations")
    print("="*80)
