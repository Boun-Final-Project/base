...
Usage:
    python3 -m reinforcement_learning.test_filament_plume
    python3 -m reinforcement_learning.test_filament_plume --seed 42 --steps 200
    python3 -m reinforcement_learning.test_filament_plume --animate --steps 300
"""
