...
Saves one PNG per map under ``reinforcement_learning/test/gaden_trajectories/<run-name>/``.

Usage
-----
    python -m reinforcement_learning.test.visualize_gaden_trajectories \\
        --run-dir base/reinforcement_learning/runs/ppo_spatial_ent_20260424_164042_job4475 \\
