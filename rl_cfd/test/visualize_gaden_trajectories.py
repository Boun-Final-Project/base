...
Saves one PNG per map under ``rl_cfd/test/gaden_trajectories/<run-name>/``.

Usage
-----
    python -m rl_cfd.test.visualize_gaden_trajectories \\
        --run-dir base/rl_cfd/runs/ppo_spatial_ent_20260424_164042_job4475 \\
