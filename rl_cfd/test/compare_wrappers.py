...
from reinforcement_learning.envs.spatial_obs_wrapper import SpatialObsWrapper as Mine
from reinforcement_learning.envs.spatial_obs_wrapper_friend import SpatialObsWrapper as Friend
